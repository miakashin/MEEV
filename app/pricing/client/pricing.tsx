          ...
          {tiers.map((tier) => (
            ...
            >
              <div className="p-8">
                ...
                <Link
                  href="/pricing/submit"
                  className="w-full py-3 px-6 rounded-full font-semibold text-center inline-flex items-center justify-center bg-blue-600 text-white hover:bg-blue-700 transition-colors"
                >
                  Start Your Journey
                </Link>
              </div>
