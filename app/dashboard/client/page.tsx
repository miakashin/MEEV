...
export default function ClientDashboardPage() {
  ...
  useEffect(() => {
    ...
    } else if (status === "authenticated" && session.user.userType !== "client") {
  ...
  const user = session?.user || { name: "Client User", email: "client@example.com" };
    ...
    <div className="py-20 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="text-gray-600 text-center">
          <p>This is your private dashboard as a client. More features coming soon!</p>
        </div>
      </div>
    </div>
  );
